...
<html lang="en">
<head>
<title>CityFoods Patna| Online Order Form-Food Delivery</title>
	...
	?>
							<form id="ContactForm" name="mF" onSubmit="return check()" action="orderformsubmit.php" method="POST">
								<div>
									...
									<br>
									<div class="wrapper">
										<span>Your Home is  Near :</span>
										<select class="input" name="area">
									<option value="Kbagh">Kankerbagh</option>
									<option value="RzBaz">Raza Bazaar</option>
									</select>								
									</div>
